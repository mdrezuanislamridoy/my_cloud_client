      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#0B1220] hover:bg-[#1E293B] border border-[#1E293B] text-white font-medium py-3 rounded-xl transition-colors"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#0F172A] text-[#64748B]">Or continue with email</span>
            </div>
          </div>
