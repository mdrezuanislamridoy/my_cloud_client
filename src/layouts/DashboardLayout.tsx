...
import {
  ...
  Settings, Shield, Menu, X, LogOut, User, Package
} from "lucide-react";
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1E293B]">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-7 h-7 bg-gradient-to-br from-[#7C3AED] to-[#22D3EE] rounded-lg" />
            <span className="font-bold text-white">MyCloud</span>
          </Link>
